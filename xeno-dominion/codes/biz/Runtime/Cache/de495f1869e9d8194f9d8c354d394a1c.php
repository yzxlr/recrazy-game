      ...
      <tbody>
        <tr>
          ...
          <td><div class="column subHead">
              <input value="<?php echo ($data["tb_user_profile"]["profile_name"]); ?>" name="profile_name" maxlength="100" style="WIDTH: 100px" />
            </div>
        ...
        <tr>
          ...
          <td nowrap="">
          	<input type="radio" name="profile_gender" value="m" <?php if(($data["tb_user_profile"]["profile_gender"])  ==  "m"): ?>checked="checked"<?php endif; ?> />
            <label for="mr">Male</label>
            <input type="radio" name="profile_gender" value="f" <?php if(($data["tb_user_profile"]["profile_gender"])  ==  "f"): ?>checked="checked"<?php endif; ?> />
            <label for="ms">Female</label></td>
        </tr>
        <tr>
          <th><span>Alternative Email Address:</span></th>
          <td><input style="width:300px;" maxlength="128" value="<?php echo ($data["tb_user_profile"]["profile_email"]); ?>" name="profile_email">
            <br>
        ...
        <tr>
          ...
          <td><table cellspacing="2" cellpadding="0" border="0">
              <tbody>
                <tr>
                  <td><input type="text" value="<?php echo ($data["tb_user_profile"]["profile_phone"]); ?>" size="6" maxlength="8" name="profile_phone">
                    </span></span></td>
                  <td></td>
                  <td></td>
                </tr>
        ...
        <tr>
          ...
          <td><table cellspacing="2" cellpadding="0" border="0">
              <tbody>
                <tr>
                  <td><input type="text" value="<?php echo ($data["tb_user_profile"]["profile_fax"]); ?>" size="6" maxlength="8" name="profile_fax"></td>
                </tr>
              </tbody>
            </table></td>
        </tr>
        <tr>
          <th>Mobile:</th>
          <td><input value="<?php echo ($data["tb_user_profile"]["profile_mobile"]); ?>" name="profile_mobile" size="6" maxlength="16" style="WIDTH: 100px"></td>
        </tr>
        <tr>
          <th>Department:</th>
          <td><select name="profile_department">
              <option selected="" value="">--- Please select ---</option>
              <option value="Director/CEO/General Manager" <?php if(($data["tb_user_profile"]["profile_department"])  ==  "Director/CEO/General Manager"): ?>selected="selected"<?php endif; ?>>Director/CEO/General Manager </option>
              <option value="Sales" <?php if(($data["tb_user_profile"]["profile_department"])  ==  "Sales"): ?>selected="selected"<?php endif; ?>>Sales </option>
              <option value="Purchasing" <?php if(($data["tb_user_profile"]["profile_department"])  ==  "Purchasing"): ?>selected="selected"<?php endif; ?>>Purchasing </option>
              <option value="Technical &amp; Engineering" <?php if(($data["tb_user_profile"]["profile_department"])  ==  "Technical &amp; Engineering"): ?>selected="selected"<?php endif; ?>>Technical &amp; Engineering </option>
              <option value="Other" <?php if(($data["tb_user_profile"]["profile_department"])  ==  "Other"): ?>selected="selected"<?php endif; ?>>Other </option>
              <option value="Administrative" <?php if(($data["tb_user_profile"]["profile_department"])  ==  "Administrative"): ?>selected="selected"<?php endif; ?>>Administrative </option>
              <option value="Marketing" <?php if(($data["tb_user_profile"]["profile_department"])  ==  "Marketing"): ?>selected="selected"<?php endif; ?>>Marketing </option>
              <option value="Owner/Entrepreneur" <?php if(($data["tb_user_profile"]["profile_department"])  ==  "Owner/Entrepreneur"): ?>selected="selected"<?php endif; ?>>Owner/Entrepreneur </option>
            </select></td>
        </tr>
        <tr>
          <th> Job Title: </th>
          <td><input type="text" size="33" value="<?php echo ($data["tb_user_profile"]["profile_jobtitle"]); ?>" name="profile_jobtitle" maxlength="32"></td>
        </tr>
        <tr>
