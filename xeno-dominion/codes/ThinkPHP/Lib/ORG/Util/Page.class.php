...
class Page extends Think {
    ...
    protected $rollPage   ;
	// 分页显示定制
    protected $config  =	array('header'=>'record(s)','prev'=>'pre','next'=>'next','first'=>'first Page','last'=>'last Page','theme'=>' %totalRow% %header% %nowPage%/%totalPage% page %upPage% %downPage% %first%  %prePage%  %linkPage%  %nextPage% %end%');
