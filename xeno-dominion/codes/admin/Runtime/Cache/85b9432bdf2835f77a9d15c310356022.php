...
<tr bgcolor="#E7E7E7">
	<td height="30" colspan="10"><span style="float:left; padding-top:3px; padding-left:5px;">Post Category List</span><span style="float:right;"><input type='button' class="coolbg np" onClick="location='__APP__/Postcategory/add';" value='Add New Category' /></span></td>
</tr>
