...
<div id="content">
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                <td>User Name:</td>
                <td><input type="text" name="user_name" value="<?php echo ($msg["tb_users"]["user_name"]); ?>" /></td>
            </tr>
            <tr>
                <td>Nickname:</td>
                <td><input type="text" name="user_nickname" value="<?php echo ($msg["tb_users"]["user_nickname"]); ?>" /></td>
            </tr>
            <tr>
                <td>User Email:</td>
                <td><input type="text" name="user_email" value="<?php echo ($msg["tb_users"]["user_email"]); ?>" /></td>
            </tr>
            <tr>
                <td>Password : </td>
