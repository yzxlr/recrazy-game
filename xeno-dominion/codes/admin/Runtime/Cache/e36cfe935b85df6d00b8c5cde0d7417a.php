...
<form id="add_cat" name="add_cat" method="post" action="__APP__/Postcategory/lang_edit/cat_id/<?php echo ($_GET['cat_id']); ?>/catlang_id/<?php echo ($_GET['catlang_id']); ?>">
<input type="hidden" name="cat_id" value="<?php echo ($_GET['cat_id']); ?>" />
<table width="98%" align="center" border="0" cellpadding="3" cellspacing="1" bgcolor="#CBD8AC" style="margin-bottom:8px;margin-top:8px;">
  <tr>
    <td colspan="2" bgcolor="#EEF4EA" class='title'><span>为 <?php echo ($data["tb_postCat"]["cat_name"]); ?> 分类修改语言和内容</span></td>
  </tr>
  <tr bgcolor="#FFFFFF">
    <td width="18%"><div align="right">分类名称&nbsp; </div></td>
    <td width="82%"><input name="cat_name" value="<?php echo ($data["tb_postCatLang"]["cat_name"]); ?>" type="text" size="30"/>&nbsp; <font color="#FF0000">*</font></td>
  </tr>
  <tr bgcolor="#FFFFFF">
    <td width="18%"><div align="right">语言&nbsp; </div></td>
    <td width="82%">
    	<select name="lang_code">
    	<?php if(is_array($data["tb_langs"])): foreach($data["tb_langs"] as $key=>$vo): ?><option value="<?php echo ($vo["lang_code"]); ?>" <?php if(($vo["lang_code"])  ==  $data["tb_postCatLang"]["lang_code"]): ?>selected="selected"<?php endif; ?> ><?php echo ($vo["language"]); ?></option><?php endforeach; endif; ?>
        </select>
    </td>
  </tr>
  <tr bgcolor="#FFFFFF">
