    ...
    <ul class="product_list">
      <?php if(is_array($data["tb_products"])): foreach($data["tb_products"] as $key=>$vo): ?><li>
          ...
          <div class="company_info">
            ...
            <p> 
            	<?php if(($vo["type"])  ==  "1"): ?><a class="contact_btn" href="mailto:<?php echo ($vo["user_email"]); ?>">Contact Supplier</a><?php endif; ?>
                <?php if(($vo["type"])  ==  "2"): ?><a class="contact_btn" href="mailto:<?php echo ($vo["user_email"]); ?>">Contact Buyer</a><?php endif; ?>
            </p>
          </div>
