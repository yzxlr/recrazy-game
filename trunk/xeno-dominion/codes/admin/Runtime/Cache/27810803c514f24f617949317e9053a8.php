...
<tr bgcolor="#E7E7E7">
	<td height="30" colspan="10">
    	<span style="float:left; padding-top:3px; padding-left:5px;">Language List under <?php echo ($data["tb_productsCat"]["cat_name"]); ?> Category </span>
        <span style="float:right;"><a href="__URL__/lang_add/cat_id/<?php echo ($_GET['cat_id']); ?>">Add a Language</a></span>
    </td>
</tr>
...
<?php if(is_array($data["postCatLang"])): foreach($data["postCatLang"] as $key=>$vo): ?><tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22" >
	<td><?php echo ($vo["catlang_id"]); ?></td>
	<td><?php echo ($vo["cat_name"]); ?></td>
	<td><?php echo ($vo["lang_name"]); ?></td>
	<td>
    	<a href="__URL__/lang_edit/cat_id/<?php echo ($_GET['cat_id']); ?>/catlang_id/<?php echo ($vo["catlang_id"]); ?>">Edit</a> | 
    	<a href="javascript:del(<?php echo ($vo["catlang_id"]); ?>)">Delete</a>
    </td>
